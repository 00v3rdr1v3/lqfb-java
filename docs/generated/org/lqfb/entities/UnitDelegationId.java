...
/**
 * UnitDelegationId generated by hbm2java
 */
@Embeddable
public class UnitDelegationId  implements java.io.Serializable {
    ...
    public UnitDelegationId() {
    }

    public UnitDelegationId(Integer unitId, Long id, Integer trusterId, Integer trusteeId, Serializable scope) {
       this.unitId = unitId;
       this.id = id;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof UnitDelegationId) ) return false;
		 UnitDelegationId castOther = ( UnitDelegationId ) other; 
