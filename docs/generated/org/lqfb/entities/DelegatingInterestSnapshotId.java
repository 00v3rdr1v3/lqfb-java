...
/**
 * DelegatingInterestSnapshotId generated by hbm2java
 */
@Embeddable
public class DelegatingInterestSnapshotId  implements java.io.Serializable {
    ...
    public DelegatingInterestSnapshotId() {
    }

    public DelegatingInterestSnapshotId(int issueId, Serializable event, int memberId) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof DelegatingInterestSnapshotId) ) return false;
		 DelegatingInterestSnapshotId castOther = ( DelegatingInterestSnapshotId ) other; 
