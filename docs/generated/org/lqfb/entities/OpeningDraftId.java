...
/**
 * OpeningDraftId generated by hbm2java
 */
@Embeddable
public class OpeningDraftId  implements java.io.Serializable {
    ...
    public OpeningDraftId() {
    }

    public OpeningDraftId(Integer initiativeId, Long id, Date created, Integer authorId, String formattingEngine, String content, Serializable textSearchData) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof OpeningDraftId) ) return false;
		 OpeningDraftId castOther = ( OpeningDraftId ) other; 
