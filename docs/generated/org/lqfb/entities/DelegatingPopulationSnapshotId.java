...
/**
 * DelegatingPopulationSnapshotId generated by hbm2java
 */
@Embeddable
public class DelegatingPopulationSnapshotId  implements java.io.Serializable {
    ...
    public DelegatingPopulationSnapshotId() {
    }

    public DelegatingPopulationSnapshotId(int issueId, Serializable event, int memberId) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof DelegatingPopulationSnapshotId) ) return false;
		 DelegatingPopulationSnapshotId castOther = ( DelegatingPopulationSnapshotId ) other; 
