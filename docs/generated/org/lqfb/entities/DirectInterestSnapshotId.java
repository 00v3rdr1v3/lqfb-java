...
/**
 * DirectInterestSnapshotId generated by hbm2java
 */
@Embeddable
public class DirectInterestSnapshotId  implements java.io.Serializable {
    ...
    public DirectInterestSnapshotId() {
    }

    public DirectInterestSnapshotId(int issueId, Serializable event, int memberId) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof DirectInterestSnapshotId) ) return false;
		 DirectInterestSnapshotId castOther = ( DirectInterestSnapshotId ) other; 
