...
/**
 * RenderedVotingCommentId generated by hbm2java
 */
@Embeddable
public class RenderedVotingCommentId  implements java.io.Serializable {
    ...
    public RenderedVotingCommentId() {
    }

    public RenderedVotingCommentId(int issueId, int memberId, String format) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof RenderedVotingCommentId) ) return false;
		 RenderedVotingCommentId castOther = ( RenderedVotingCommentId ) other; 
