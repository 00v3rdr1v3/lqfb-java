...
/**
 * IssueCommentId generated by hbm2java
 */
@Embeddable
public class IssueCommentId  implements java.io.Serializable {
    ...
    public IssueCommentId(int issueId, int memberId) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof IssueCommentId) ) return false;
		 IssueCommentId castOther = ( IssueCommentId ) other; 
