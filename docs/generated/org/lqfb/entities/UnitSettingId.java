...
/**
 * UnitSettingId generated by hbm2java
 */
@Embeddable
public class UnitSettingId  implements java.io.Serializable {
    ...
    public UnitSettingId() {
    }

    public UnitSettingId(int memberId, String key, int unitId) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof UnitSettingId) ) return false;
		 UnitSettingId castOther = ( UnitSettingId ) other; 
